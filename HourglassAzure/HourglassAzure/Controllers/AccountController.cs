...
using HourglassAzure.Models.AccountViewModels;
...
namespace HourglassAzure.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> LoginWith2fa(LoginWith2faViewModel model, bool rememberMe, string returnUrl = null)
        {
            ...
            {
                _logger.LogWarning("Código do autenticador inválido inserido para usuário com ID {UserId}.", user.Id);
        ...
        public async Task<IActionResult> LoginWithRecoveryCode(LoginWithRecoveryCodeViewModel model, string returnUrl = null)
        {
            ...
            {
                _logger.LogWarning("Código de recuperação inválido digitado para usuário com ID {UserId}", user.Id);
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("Usuário logado com {Name}.", info.LoginProvider);
                return RedirectToLocal(returnUrl);
            }
            if (result.IsLockedOut)
            {
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            return View(result.Succeeded ? "Confirmar e-mail" : "Erro");
        }
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "Resetar senha",
