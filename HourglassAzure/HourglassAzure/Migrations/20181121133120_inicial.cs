        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrigemTramite = table.Column<bool>(nullable: false),
                    Pbi = table.Column<int>(nullable: false),
                    Projeto = table.Column<string>(nullable: true),
                    Tarefa = table.Column<int>(nullable: false),
                    Titulo = table.Column<string>(nullable: true),
                    TramiteEditado = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tramite", x => x.TramiteID);
                });
