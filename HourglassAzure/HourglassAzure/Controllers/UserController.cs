...
namespace IdentitySampleApplication.Controllers
{
    public class UserController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            model.ForEach(u => {
                var user = userManager.Users.Where(w => w.Id == u.Id).Single();
                u.RoleName = string.Join(",", userManager.GetRolesAsync(user).Result.ToArray());
            });
            return View(model);
        }
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            if (!String.IsNullOrEmpty(id))
            {
                ...
                if (user != null)
                {
                    ...
                    model.ApplicationRoleId = userManager.GetRolesAsync(user).Result.Count > 0  ? roleManager.Roles.Single(r => r.Name == userManager.GetRolesAsync(user).Result.Single()).Id :"";
                }
